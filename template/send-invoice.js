...
<div style="width:100%;max-width:860px;margin:0 auto;background:#ffffff;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td style="vertical-align:top;text-align:right;">
          ...
          <div style="font-family:'Courier New',monospace;font-size:13px;color:#ffffff;margin-top:3px;">{{issueDate}}</div>
        </td>
      </tr>
    </table>
  </div>
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="border-bottom:1px solid #dde2ec;">
    <tr>
      ...
      <td style="padding:18px 24px;border-right:1px solid #dde2ec;width:25%;">
        <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.12em;color:#8a92a6;margin-bottom:5px;">Batch</div>
        <div style="font-size:13px;font-weight:700;color:#0f1117;">{{batchName}}</div>
      </td>
      <td style="padding:18px 24px;border-right:1px solid #dde2ec;width:25%;">
        <div style="font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:0.12em;color:#8a92a6;margin-bottom:5px;">Batch Dates</div>
        <div style="font-family:'Courier New',monospace;font-size:11.5px;color:#4a5060;">{{batchStartDate}} – {{batchEndDate}}</div>
      </td>
      ...
      <tr>
        ...
        <td style="width:48%;vertical-align:top;padding-right:12px;">
          <div style="background:#f4f6fb;border-radius:14px;padding:20px 22px;border:1px solid #dde2ec;">
            ...
            <div style="font-size:15px;font-weight:800;color:#0f1117;margin-bottom:8px;text-transform:capitalize;">{{studentName}}</div>
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td style="font-size:11px;color:#8a92a6;padding-right:8px;padding-bottom:4px;white-space:nowrap;">Email</td>
                <td style="font-size:12px;color:#0f1117;padding-bottom:4px;">{{studentEmail}}</td>
              </tr>
              <tr>
                <td style="font-size:11px;color:#8a92a6;padding-right:8px;padding-bottom:4px;white-space:nowrap;">Phone</td>
                <td style="font-size:12px;font-weight:600;color:#0f1117;padding-bottom:4px;">{{studentPhone}}</td>
              </tr>
              <tr>
                <td style="font-size:11px;color:#8a92a6;padding-right:8px;padding-bottom:4px;white-space:nowrap;">CNIC</td>
                <td style="font-family:'Courier New',monospace;font-size:12px;color:#0f1117;padding-bottom:4px;">{{studentCnic}}</td>
              </tr>
              <tr>
        ...
        <td style="width:48%;vertical-align:top;padding-left:12px;">
          <div style="background:#f4f6fb;border-radius:14px;padding:20px 22px;border:1px solid #dde2ec;">
            ...
            <div style="font-size:15px;font-weight:800;color:#0f1117;margin-bottom:8px;">Arslan Larik &amp; Company</div>
            <table cellpadding="0" cellspacing="0">
              <tr>
                <td style="font-size:11px;color:#8a92a6;padding-right:8px;padding-bottom:4px;white-space:nowrap;">Brand</td>
                <td style="font-size:12px;color:#0f1117;padding-bottom:4px;">ALCO — Finance Dept.</td>
              </tr>
              <tr>
                <td style="font-size:11px;color:#8a92a6;padding-right:8px;padding-bottom:4px;white-space:nowrap;">NTN</td>
                <td style="font-family:'Courier New',monospace;font-size:12px;color:#0f1117;padding-bottom:4px;">2826497-5</td>
              </tr>
              <tr>
                <td style="font-size:11px;color:#8a92a6;padding-right:8px;padding-bottom:4px;white-space:nowrap;">Manager</td>
