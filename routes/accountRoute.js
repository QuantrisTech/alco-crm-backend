...
router.patch("/expense-titles/:id", protect, financeAdmin, updateExpenseTitle);
router.delete("/expense-titles/:id", protect, financeAdmin, deleteExpenseTitle);
...
// ✅ /:id routes LAST
router.get("/",      protect, financeAdmin, getAllAccounts);
router.post("/",     protect, financeAdmin, createAccount);
router.get("/:id",   protect, financeAdmin, getAccountById);
router.patch("/:id", protect, financeAdmin, updateAccount);
router.delete("/:id",protect, financeAdmin, deleteAccount);
